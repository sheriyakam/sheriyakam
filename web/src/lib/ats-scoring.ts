...
function extractJobKeywords(jobDescription: any): string[] {
  ...
  // Basic regex frequency extractor for high-value technical & domain keywords
...
export async function calculateAtsScore(
  ...
  // Check for quantifiable metric numbers (% or $) and strong action verbs
  let clarityScore = 70;
  ...
  // Optional qualitative pass via Groq fast model
...
Return strictly JSON: { "clarityScore": 85, "additionalSuggestion": "..." }`,
  ...
  // Calculate composite ATS score: 40% Keywords, 30% Structure, 30% Clarity
