...
export async function generateResumeExport(resume: ExportResumeData) {
  ...
  // In production with S3/Supabase storage, upload buffer and get signed URL.
  // Here we provide reliable data URLs and standard download URIs.
  return {
    pdfUrl: htmlDataUri, // Text-selectable vector print output
